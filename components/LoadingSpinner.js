    ...
    <div className="gradient-bg flex items-center justify-center min-h-screen">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="relative">
          <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center" style={{animation: 'spin 3s linear infinite'}}>
          ...
          <div className="absolute inset-0 bg-orange-500 rounded-2xl opacity-30 blur-xl ping"></div>
        </div>
